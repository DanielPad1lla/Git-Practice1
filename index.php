...
<head>
    ...
    <title>Ferretería La Bendición</title>
...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Ferretería La Bendición</a>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 m-4">
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="img/ferreteriaProductos.webp" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
      </div>
